...
var resolveAssumeRoleCredentials = async (profileName, profiles, options, visitedProfiles = {}) => {
  ...
  if (!options.roleAssumer) {
    const { getDefaultRoleAssumer } = await import("./sts-JGKOLFCW.js");
...
var resolveWebIdentityCredentials = async (profile, options) => import("./dist-es-FO3XJCPC.js").then(({ fromTokenFile }) => fromTokenFile({
